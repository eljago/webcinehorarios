...
ActiveRecord::Schema.define(version: 20160606083948) do
  ...
  create_table "show_debuts", force: true do |t|
    t.integer  "show_id"
    t.date     "debut"
    t.datetime "created_at"
  end

  add_index "show_debuts", ["show_id"], name: "index_show_debuts_on_show_id", using: :btree
